...
<Note>
**Preview.** The Founder API is live on the **sandbox** (`api-sandbox.venture.caplia.ai`, `mcp-sandbox.venture.caplia.ai`) for integration today; production launches with our next release. Mint a company-scoped key in the founder portal - see [Authentication](/founder/authentication).
</Note>
